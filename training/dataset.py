...
from jittor.dataset import RandomSampler, SequentialSampler, BatchSampler
...
def creat_dataloader(data_dir, size, batch, img_channel=3):
    ...
    loader = BatchSampler(dataset,sampler=sampler,batch_size=batch,drop_last=True)
